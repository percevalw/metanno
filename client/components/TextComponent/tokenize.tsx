 ...
 * @param styles
 */
function styleTextChunks_(text_chunks: TextChunk[], spans: TextAnnotation[], styles: { [key: string]: PreprocessedStyle }) {
...
export default function tokenize(spans: TextAnnotation[], text: string, styles: { [key: string]: PreprocessedStyle }): {
    lines: TokenData[][];
    ids: any[];
} {
