...
// noinspection EqualityComparisonWithCoercionJS,SpellCheckingInspection

const __name__ = 'org.transcrypt.__runtime__';
...
function __getdefault__ (aKey, aDefault) {
    if (!(this instanceof Object))
        return this.get(aKey, aDefault)
    let result = this [aKey];
    if (result == undefined) {
...
function __setdefault__ (aKey, aDefault) {
    if (!(this instanceof Object))
        return this.setdefault(aKey, aDefault)
    const result = this [aKey];
    if (result != undefined) {
        return result;
    }
    const val = aDefault == undefined ? null : aDefault;
    this [aKey] = val;
    return val;
}
function __pop__ (aKey, aDefault) {
    if (!(this instanceof Object))
        return this.pop(aKey, aDefault)
    const result = this [aKey];
    if (result != undefined) {
        delete this [aKey];
        return result;
...
function __update__ (aDict) {
    if (!(this instanceof Object))
        return this.update(aDict)
    for (let aKey in aDict) {
...
__setproperty__ (Object.prototype, '__class__', {value: dict, enumerable: false, writable: true});
// __setproperty__ (Object.prototype, '__contains__', {value: __contains__, enumerable: false});
__setproperty__ (Object.prototype, 'py_keys', {value: __keys__, enumerable: false});
__setproperty__ (Object.prototype, '__iter__', {value: function () {new __PyIterator__ (this.py_keys ());}, enumerable: false});
// __setproperty__ (Object.prototype, Symbol.iterator, {value: function () {new __JsIterator__ (this.py_keys ());}, enumerable: false});
__setproperty__ (Object.prototype, 'py_items', {value: __items__, enumerable: false});
__setproperty__ (Object.prototype, 'py_del', {value: __del__, enumerable: false});
__setproperty__ (Object.prototype, 'py_clear', {value: __clear__, enumerable: false});
__setproperty__ (Object.prototype, 'py_get', {value: __getdefault__, enumerable: false});
__setproperty__ (Object.prototype, 'py_setdefault', {value: __setdefault__, enumerable: false});
__setproperty__ (Object.prototype, 'py_pop', {value: __pop__, enumerable: false});
__setproperty__ (Object.prototype, 'py_popitem', {value: __popitem__, enumerable: false});
__setproperty__ (Object.prototype, 'py_update', {value: __update__, enumerable: false});
__setproperty__ (Object.prototype, 'py_values', {value: __values__, enumerable: false});
__setproperty__ (Object.prototype, '__getitem__', {value: __dgetitem__, enumerable: false});
__setproperty__ (Object.prototype, '__setitem__', {value: __dsetitem__, enumerable: false});
dict.__name__ = 'dict';
dict.__bases__ = [object];

export function __nest__ (headObject, tailNames, value) {
    let current = headObject;
    if (tailNames != '') {
        const tailChain = tailNames.split('.');
        let firstNewIndex = tailChain.length;
...
export var py_metatype = {
    ...
    __new__: function (meta, name, bases, attribs) {
        const cls = function () {
            const args = [].slice.apply(arguments);
            const instance = cls.__new__(cls, ...args);
            if (instance.__class__ === cls) {
                instance.__init__.apply(null, args);
            }
            return instance;
        };
...
__envir__.executor_name = __envir__.transpiler_name;
const __main__ = {__file__: ''};
const __except__ = null;
...
export function __super__ (aClass, methodName) {
    for (let base of aClass.__bases__) {
        if (methodName in base) {
           return base [methodName].bind(aClass);
        }
    }
...
export function issubclass (aClass, classinfo) {
    ...
    try {
        ...
        if (aClass2 == classinfo) {
            ...
            let bases = [].slice.call(aClass2.__bases__);
            while (bases.length) {
                aClass2 = bases.shift ();
                if (aClass2 == classinfo) {
                    return true;
...
export function zip () {
    ...
    const shortest = args.length == 0 ? [] : args.reduce(
...
__setproperty__(Array.prototype, '__iter__', {'value': function array_iter () {
    return new __PyIterator__ (this)
}, 'enumeratable': false, 'writable': false});

__setproperty__(Array.prototype, '__getslice__', {'value': function (start, stop, step) {
    if (start < 0) {
...
__setproperty__(Array.prototype, '__setslice__', {'value': function (start, stop, step, source) {
    if (start < 0) {
        start = this.length + start;
    }
    if (stop == null) {
...
__setproperty__(Array.prototype, '__repr__', {'value': function () {
...
__setproperty__(Array.prototype, '__str__', {'value': Array.prototype.__repr__ });
__setproperty__(Array.prototype, 'append', {'value': function (element) {
    this.push (element);
}, 'enumeratable': false, 'writable': false});
__setproperty__(Array.prototype, 'py_clear', {'value': function () {
    this.length = 0;
}, 'enumeratable': false, 'writable': false});
__setproperty__(Array.prototype, 'extend', {'value': function (aList) {
    this.push.apply (this, aList);
}, 'enumeratable': false, 'writable': false});
__setproperty__(Array.prototype, 'insert', {'value': function (index, element) {
    this.splice (index, 0, element);
}, 'enumeratable': false, 'writable': false});
__setproperty__(Array.prototype, 'remove', {'value': function (element) {
...
__setproperty__(Array.prototype, 'index', {'value': function (element) {
    return this.indexOf (element);
}, 'enumeratable': false, 'writable': false});
__setproperty__(Array.prototype, 'py_pop', {'value': function (index) {
    if (index == undefined) {
        return this.pop ();
    }
    else {
...
__setproperty__(Array.prototype, 'py_sort', {'value': function () {
    __sort__.apply  (null, [this].concat ([] .slice.apply (arguments)));
}, 'enumeratable': false, 'writable': false});
__setproperty__(Array.prototype, '__add__', {'value': function (aList) {
    return list (this.concat (aList));
}, 'enumeratable': false, 'writable': false});
__setproperty__(Array.prototype, '__mul__', {'value': function (scalar) {
    let result = this;
...
__setproperty__(Array.prototype, '__rmul__', {'value': Array.prototype.__mul__, 'enumeratable': false, 'writable': false});;
...
__setproperty__(Array.prototype, '__bindexOf__', {'value': function (element) {
    element += '';
    let mindex = 0;
...
__setproperty__(Array.prototype, 'add', {'value': function (element) {
    if (this.indexOf (element) == -1) {
        this.push (element);
    }
}, 'enumerable': false, 'writable': false});
__setproperty__(Array.prototype, 'discard', {'value': function (element) {
        const index = this.indexOf(element);
        if (index != -1) {
        this.splice (index, 1);
    }
}, 'enumerable': false, 'writable': false});
__setproperty__(Array.prototype, 'isdisjoint', {'value': function (other) {
    this.sort ();
...
__setproperty__(Array.prototype, 'issuperset', {'value': function (other) {
    this.sort ();
    for (let i = 0; i < other.length; i++) {
        if (this.__bindexOf__ (other [i]) == -1) {
            return false;
...
__setproperty__(Array.prototype, 'issubset', {'value': function (other) {
    return set (other.slice ()) .issuperset (this);
}, 'enumerable': false, 'writable': false});
__setproperty__(Array.prototype, 'union', {'value': function (other) {
...
__setproperty__(Array.prototype, 'intersection', {'value': function (other) {
    this.sort ();
    let result = set ();
    for (let i = 0; i < other.length; i++) {
        if (this.__bindexOf__ (other [i]) != -1) {
...
__setproperty__(Array.prototype, 'difference', {'value': function (other) {
...
__setproperty__(Array.prototype, 'symmetric_difference', {'value': function (other) {
    return this.union (other) .difference (this.intersection (other));
}, 'enumerable': false, 'writable': false});
__setproperty__(Array.prototype, 'py_update', {'value': function () {
...
__setproperty__(Array.prototype, '__eq__', {'value': function (other) {
...
__setproperty__(Array.prototype, '__ne__', {'value': function (other) {
    return !this.__eq__ (other);
}, 'enumerable': false, 'writable': false});
__setproperty__(Array.prototype, '__le__', {'value': function (other) {
    if (this.__class__ == set) {
...
__setproperty__(Array.prototype, '__ge__', {'value': function (other) {
    if (this.__class__ == set) {
...
__setproperty__(Array.prototype, '__lt__', {'value': function (other) {
    return (
        this.__class__ == set ?
...
__setproperty__(Array.prototype, '__gt__', {'value': function (other) {
    return (
        this.__class__ == set ?
...
__setproperty__(String.prototype, '__iter__', {'value': function () {new __PyIterator__ (this);}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, '__repr__', {'value': function () {
    return (this.indexOf ('\'') == -1 ? '\'' + this + '\'' : '"' + this + '"') .py_replace ('\t', '\\t') .py_replace ('\n', '\\n');
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, '__str__', {'value': function () {
    return this;
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'capitalize', {'value': function () {
    return this.charAt (0).toUpperCase () + this.slice (1);
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'endswith', {'value': function (suffix) {
...
__setproperty__(String.prototype, 'find', {'value': function (sub, start) {
    return this.indexOf (sub, start);
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, '__getslice__', {'value': function (start, stop, step) {
    if (start < 0) {
        start = this.length + start;
    }
    if (stop == null) {
...
__setproperty__ (String.prototype, 'format', {
    get: function () {return __get__ (this, function (self) {
        const args = tuple([].slice.apply(arguments).slice(1));
        let autoIndex = 0;
...
__setproperty__(String.prototype, 'isalnum', {'value': function () {
    return /^[0-9a-zA-Z]{1,}$/.test(this)
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'isalpha', {'value': function () {
    return /^[a-zA-Z]{1,}$/.test(this)
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'isdecimal', {'value': function () {
    return /^[0-9]{1,}$/.test(this)
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'isdigit', {'value': function () {
    return this.isdecimal()
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'islower', {'value': function () {
    return /^[a-z]{1,}$/.test(this)
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'isupper', {'value': function () {
    return /^[A-Z]{1,}$/.test(this)
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'isspace', {'value': function () {
    return /^[\s]{1,}$/.test(this)
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'isnumeric', {'value': function () {
    return !isNaN (parseFloat (this)) && isFinite (this);
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'join', {'value': function (strings) {
    strings = Array.from (strings);
    return strings.join (this);
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'lower', {'value': function () {
    return this.toLowerCase ();
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'py_replace', {'value': function (old, aNew, maxreplace) {
    return this.split (old, maxreplace) .join (aNew);
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'lstrip', {'value': function () {
    return this.replace (/^\s*/g, '');
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'rfind', {'value': function (sub, start) {
    return this.lastIndexOf (sub, start);
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'rsplit', {'value': function (sep, maxsplit) {
    ...
    if (maxsplit == undefined || maxsplit == -1) {
        ...
        const result = stripped.split(sep);
        if (maxsplit < result.length) {
            const maxrsplit = result.length - maxsplit;
...
__setproperty__(String.prototype, 'rstrip', {'value': function () {
    return this.replace (/\s*$/g, '');
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'py_split', {'value': function (sep, maxsplit) {
    let stripped;
    if (sep == undefined || sep == null) {
        sep = /\s+/;
        stripped = this.strip ();
...
__setproperty__(String.prototype, 'startswith', {'value': function (prefix) {
...
__setproperty__(String.prototype, 'strip', {'value': function () {
    return this.trim ();
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, 'upper', {'value': function () {
    return this.toUpperCase ();
}, 'enumerable': false, 'writable': false});
__setproperty__(String.prototype, '__mul__', {'value': function (scalar) {
    let result = '';
    for (let i = 0; i < scalar; i++) {
        result = result + this;
    }
...
__setproperty__(String.prototype, '__rmul__', {'value': String.prototype.__mul__, 'enumerable': false, 'writable': false});;
	...
	get __init__ () {return __get__ (this, function (self) {
        ...
        if (arguments.length) {
            ...
            if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
                const __allkwargs0__ = arguments [__ilastarg0__--];
                for (let __attrib0__ in __allkwargs0__) {
					switch (__attrib0__) {
