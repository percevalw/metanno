        ...
        span_begin: begin, children: [annotations, (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { className: "text-chunk-content", 
                ...
                token_annotations.map(function (annotation, annotation_i) {
                    ...
                    if (annotation.isFirstTokenOfSpan && annotation.label) {
                        ...
                        labelIdx[shape] += 1;
                        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { className: "label ".concat(annotation.highlighted || annotation.selected
                                ? "highlighted"
    ...
    var onMouseUp = function (e) {
        ...
        if (hitElements.length > 1) {
            hitElements = hitElements
                ...
                .sort(function (a, b) {
                return Number.parseInt(a.style.zIndex) - Number.parseInt(b.style.zIndex);
            });
        }
...
var Table = function Table(_a) {
    var primaryKey = _a.primaryKey, rows = _a.rows, position = _a.position, filters = _a.filters, columns = _a.columns, autoFilter = _a.autoFilter, subset = _a.subset, onSubsetChange = _a.onSubsetChange, handle = _a.handle, onInputChange = _a.onInputChange, inputValue = _a.inputValue, onMouseEnterRow = _a.onMouseEnterRow, onMouseLeaveRow = _a.onMouseLeaveRow, onMouseHoverRow = _a.onMouseHoverRow, highlightedRows = _a.highlightedRows, style = _a.style, onFiltersChange = _a.onFiltersChange, onPositionChange = _a.onPositionChange, onCellChange = _a.onCellChange, onScrollBottom = _a.onScrollBottom, onClickCellContent = _a.onClickCellContent, suggestions = _a.suggestions;
    var _b = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(columns.map(function (column) { return column.key; })), 2), columnsOrder = _b[0], setColumnsOrder = _b[1];
    var _c = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(undefined), 2), localPosition = _c[0], setLocalPosition = _c[1];
    var _d = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false), 2), isLoading = _d[0], setIsLoading = _d[1];
    // If filters are not controlled via props, we use local state
    var _e = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({}), 2), localFilters = _e[0], setLocalFilters = _e[1];
    ...
    var makeFilterInput = function (column) {
        return column.filterable
            ? function (inputProps) { return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("input", __assign({}, inputProps, { className: "metanno-table-filter", value: effectiveFilters[column.key] || "", onChange: function (e) {
                    ...
                    onFiltersChange === null || onFiltersChange === void 0 ? void 0 : onFiltersChange(newFilters, column.key);
    ...
    var handlePositionChange = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useEventCallback)(function (_a) {
        var idx = _a.idx, rowIdx = _a.rowIdx, mode = _a.mode, _b = _a.cause, cause = _b === void 0 ? "key" : _b;
        var absoluteRowIdx = rowIdx !== null && rowIdx >= 0 ? getAbsoluteRowIdx(rowIdx) : null;
        var col = idx !== null && idx >= 0 ? columnsOrder[idx] : null;
        onPositionChange === null || onPositionChange === void 0 ? void 0 : onPositionChange(primaryKey && absoluteRowIdx !== null ? rowsRef.current[absoluteRowIdx][primaryKey] : null, absoluteRowIdx, col, mode, cause);
    ...
    var getPositionIndices = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useCachedReconcile)(function (positionParam) {
        ...
        var relativeRowIdx = row_idx === null
            ? -1
            : effectiveSubset
    ...
    var onBlur = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useEventCallback)(function (event) {
        if (event.currentTarget.contains(event.relatedTarget))
            return;
        var effectivePosition = position !== undefined ? position : localPosition;
    ...
    var headerRowHeight = columns.some(function (col) { return col.filterable; })
        ? HEADER_ROW_HEIGHT
        : ROW_HEIGHT;
    var selectedPosition = getPositionIndices(position !== undefined ? position : localPosition);
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(SuggestionsContext.Provider, { value: suggestions, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "metanno-table", style: style, onBlur: onBlur, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_dnd__WEBPACK_IMPORTED_MODULE_2__.DndProvider, { backend: react_dnd_html5_backend__WEBPACK_IMPORTED_MODULE_3__.HTML5Backend, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)((react_data_grid__WEBPACK_IMPORTED_MODULE_4___default()), { ref: gridRef, rowKeyGetter: rowKeyGetter, rowHeight: ROW_HEIGHT, selectedPosition: selectedPosition, columns: builtColumns, rows: visibleRows, rowRenderer: renderRow, headerRowHeight: headerRowHeight, onRowsChange: onRowsChange, onSelectedPositionChange: handlePositionChange, onScroll: handleScrollBottom }) }) }) }));
};
...
//# sourceMappingURL=client_style_css-client_dist-globals_ts.c7fdb7ea21d034d7afa1.js.map