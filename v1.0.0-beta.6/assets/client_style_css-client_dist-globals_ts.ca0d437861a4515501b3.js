...
function tokenize(spans, text, styles, beginKey, endKey, labelKey, styleKey, highlightedKey, selectedKey, idKey) {
    spans = spans.map(function (span, span_i) { return ({
        begin: span[beginKey],
        end: span[endKey],
...
//# sourceMappingURL=client_style_css-client_dist-globals_ts.ca0d437861a4515501b3.js.map