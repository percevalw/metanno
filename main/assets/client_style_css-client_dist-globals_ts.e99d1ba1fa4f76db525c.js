...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".metanno-text-view {\n    --metanno-line-height: 2.8em;\n    --metanno-line-bleed: calc(var(--metanno-line-height) / 3);\n    --metanno-line-gutter-width: 41px;\n}\n\n.metanno-text-view:focus-visible {\n    outline: none;\n}\n\n.metanno-text-view .text {\n    /*background: var(--metanno-background-color);*/\n    font-family: var(--metanno-font-family);\n    font-size: var(--metanno-font-size);\n    padding-top: calc(var(--metanno-line-bleed) * 2);\n    padding-bottom: calc(var(--metanno-line-bleed) * 2);\n    line-height: var(--metanno-line-height);\n    color: var(--metanno-color);\n    position: relative;\n\n    width: 100%;\n    overflow-x: hidden;\n    -webkit-font-smoothing: antialiased;\n}\n\n.metanno-text-view .line {\n    margin: calc(var(--metanno-line-bleed) * -2) 0;\n    padding: var(--metanno-line-bleed) 0 var(--metanno-line-bleed) var(--metanno-line-gutter-width);\n    box-sizing: border-box;\n    width: 100%;\n    contain: layout paint style;\n    transform: translateZ(0);\n    will-change: transform;\n}\n\n.metanno-text-view .line-number {\n    margin-left: calc(var(--metanno-line-gutter-width) * -1);\n    width: 0;\n    display: inline-block;\n    padding: 0 30px 0 11px;\n    color: #959da5;\n    white-space: nowrap;\n}\n\n.metanno-text-view .line-number,\n.metanno-text-view .label {\n    -webkit-touch-callout: none; /* iOS Safari */\n    -webkit-user-select: none; /* Safari */\n    -khtml-user-select: none; /* Konqueror HTML */\n    -moz-user-select: none; /* Old versions of Firefox */\n    -ms-user-select: none; /* Internet Explorer/Edge */\n    user-select: none; /* Non-prefixed version, currently supported by Chrome, Opera and Firefox */\n}\n\n.metanno-text-view .text-chunk {\n    word-break: break-word;\n    white-space: nowrap;\n    position: relative;\n    contain: layout paint;\n}\n\n.metanno-text-view .text-chunk-content {\n    position: relative;\n    z-index: 1001;\n    white-space: pre-wrap;\n}\n\n.metanno-text-view .mention_token {\n    box-sizing: content-box;\n    border-radius: 0.0000001em;\n    display: inline-block;\n\n    pointer-events: none;\n    position: absolute;\n    background-color: var(--metanno-background-color);\n    border-color: var(--metanno-border-color);\n    left: 0px;\n    right: 0px;\n    border-width: 2px;\n    border-style: solid;\n    border-right-width: 0;\n    border-left-width: 0;\n}\n\n.metanno-text-view .label {\n    box-sizing: content-box;\n    position: absolute;\n    white-space: pre;\n    border-radius: 0.2em;\n    font-size: 0.65em;\n    padding: 0.5em 0.1em 0em;\n    background: var(--metanno-background-color);\n    line-height: 0em;\n    height: 0.4em;\n    pointer-events: none;\n    color: var(--metanno-color);\n    border: 2px solid;\n    border-color: var(--metanno-color);\n}\n\n.metanno-text-view .label.highlighted {\n    outline: 2px solid #e7c600;\n    box-shadow: none;\n}\n\n.metanno-text-view .mention_token.mention_underline, .metanno-text-view .mention_token.mention_underline.closed_left, .metanno-text-view .mention_token.mention_underline.closed_right {\n    top: calc(100% - 3px);\n    border-top: 0;\n    border-top-left-radius: 0;\n    border-top-right-radius: 0;\n}\n\n.metanno-text-view .mention_token.closedleft {\n    left: -1px;\n    border-left-width: 2px;\n    border-top-left-radius: 2px;\n    border-bottom-left-radius: 2px;\n}\n\n.metanno-text-view .mention_token.closedright {\n    right: -1px;\n    border-right-width: 2px;\n    border-top-right-radius: 2px;\n    border-bottom-right-radius: 2px;\n}\n\n.metanno-text-view .mention_token.highlighted {\n    border-top-width: 4px;\n    border-bottom-width: 4px;\n}\n\n.metanno-text-view .mention_token.mention_underline, .metanno-text-view .mention_token.closedright.mention_underline, .metanno-text-view .mention_token.closedleft.mention_underline {\n    right: -2px;\n    border-top: 0;\n    border-top-left-radius: 0;\n    border-top-right-radius: 0;\n}\n\n.metanno-text-view .mention_token.closedleft.highlighted {\n    border-left-width: 4px;\n    left: -2px;\n}\n\n.metanno-text-view .mention_token.closedright.highlighted {\n    border-right-width: 4px;\n    right: -2px;\n}\n\n.metanno-text-view .mouse_selected {\n    background: rgba(137, 188, 250, 0.6); /*#b2d7ff88;*/\n    border: none;\n    min-height: var(--metanno-line-height);\n    z-index: 1000;\n}\n\n/* Style only for Mozilla Firefox */\n@-moz-document url-prefix() {\n    .metanno-text-view .mouse_selected {\n        top: 0;\n        bottom: 0;\n        min-height: unset;\n    }\n}\n\n@keyframes blink {\n    from, to {\n        border-color: white\n    }\n    50% {\n        border-color: black\n    }\n}\n\n@media (prefers-reduced-motion: no-preference) {\n    .metanno-text-view .mention_token.selected {\n        animation: var(--blink-animation);\n    }\n}\n", "",{"version":3,"sources":["webpack://./client/components/AnnotatedText/style.css"],"names":[],"mappings":"AAGA;IACI,4BAA4B;IAC5B,0DAA0D;IAC1D,iCAAiC;AACrC;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,+CAA+C;IAC/C,uCAAuC;IACvC,mCAAmC;IACnC,gDAAgD;IAChD,mDAAmD;IACnD,uCAAuC;IACvC,2BAA2B;IAC3B,kBAAkB;;IAElB,WAAW;IACX,kBAAkB;IAClB,mCAAmC;AACvC;;AAEA;IACI,8CAA8C;IAC9C,+FAA+F;IAC/F,sBAAsB;IACtB,WAAW;IACX,2BAA2B;IAC3B,wBAAwB;IACxB,sBAAsB;AAC1B;;AAEA;IACI,wDAAwD;IACxD,QAAQ;IACR,qBAAqB;IACrB,sBAAsB;IACtB,cAAc;IACd,mBAAmB;AACvB;;AAEA;;IAEI,2BAA2B,EAAE,eAAe;IAC5C,yBAAyB,EAAE,WAAW;IACtC,wBAAwB,EAAE,mBAAmB;IAC7C,sBAAsB,EAAE,4BAA4B;IACpD,qBAAqB,EAAE,2BAA2B;IAClD,iBAAiB,EAAE,2EAA2E;AAClG;;AAEA;IACI,sBAAsB;IACtB,mBAAmB;IACnB,kBAAkB;IAClB,qBAAqB;AACzB;;AAEA;IACI,kBAAkB;IAClB,aAAa;IACb,qBAAqB;AACzB;;AAEA;IACI,uBAAuB;IACvB,0BAA0B;IAC1B,qBAAqB;;IAErB,oBAAoB;IACpB,kBAAkB;IAClB,iDAAiD;IACjD,yCAAyC;IACzC,SAAS;IACT,UAAU;IACV,iBAAiB;IACjB,mBAAmB;IACnB,qBAAqB;IACrB,oBAAoB;AACxB;;AAEA;IACI,uBAAuB;IACvB,kBAAkB;IAClB,gBAAgB;IAChB,oBAAoB;IACpB,iBAAiB;IACjB,wBAAwB;IACxB,2CAA2C;IAC3C,gBAAgB;IAChB,aAAa;IACb,oBAAoB;IACpB,2BAA2B;IAC3B,iBAAiB;IACjB,kCAAkC;AACtC;;AAEA;IACI,0BAA0B;IAC1B,gBAAgB;AACpB;;AAEA;IACI,qBAAqB;IACrB,aAAa;IACb,yBAAyB;IACzB,0BAA0B;AAC9B;;AAEA;IACI,UAAU;IACV,sBAAsB;IACtB,2BAA2B;IAC3B,8BAA8B;AAClC;;AAEA;IACI,WAAW;IACX,uBAAuB;IACvB,4BAA4B;IAC5B,+BAA+B;AACnC;;AAEA;IACI,qBAAqB;IACrB,wBAAwB;AAC5B;;AAEA;IACI,WAAW;IACX,aAAa;IACb,yBAAyB;IACzB,0BAA0B;AAC9B;;AAEA;IACI,sBAAsB;IACtB,UAAU;AACd;;AAEA;IACI,uBAAuB;IACvB,WAAW;AACf;;AAEA;IACI,oCAAoC,EAAE,aAAa;IACnD,YAAY;IACZ,sCAAsC;IACtC,aAAa;AACjB;;AAEA,mCAAmC;AACnC;IACI;QACI,MAAM;QACN,SAAS;QACT,iBAAiB;IACrB;AACJ;;AAEA;IACI;QACI;IACJ;IACA;QACI;IACJ;AACJ;;AAEA;IACI;QACI,iCAAiC;IACrC;AACJ","sourcesContent":["@import url('//fonts.googleapis.com/css?family=Roboto+Mono&display=swap');\n@import url(\"//cdn.jsdelivr.net/npm/hack-font@3/build/web/hack.css\");\n\n.metanno-text-view {\n    --metanno-line-height: 2.8em;\n    --metanno-line-bleed: calc(var(--metanno-line-height) / 3);\n    --metanno-line-gutter-width: 41px;\n}\n\n.metanno-text-view:focus-visible {\n    outline: none;\n}\n\n.metanno-text-view .text {\n    /*background: var(--metanno-background-color);*/\n    font-family: var(--metanno-font-family);\n    font-size: var(--metanno-font-size);\n    padding-top: calc(var(--metanno-line-bleed) * 2);\n    padding-bottom: calc(var(--metanno-line-bleed) * 2);\n    line-height: var(--metanno-line-height);\n    color: var(--metanno-color);\n    position: relative;\n\n    width: 100%;\n    overflow-x: hidden;\n    -webkit-font-smoothing: antialiased;\n}\n\n.metanno-text-view .line {\n    margin: calc(var(--metanno-line-bleed) * -2) 0;\n    padding: var(--metanno-line-bleed) 0 var(--metanno-line-bleed) var(--metanno-line-gutter-width);\n    box-sizing: border-box;\n    width: 100%;\n    contain: layout paint style;\n    transform: translateZ(0);\n    will-change: transform;\n}\n\n.metanno-text-view .line-number {\n    margin-left: calc(var(--metanno-line-gutter-width) * -1);\n    width: 0;\n    display: inline-block;\n    padding: 0 30px 0 11px;\n    color: #959da5;\n    white-space: nowrap;\n}\n\n.metanno-text-view .line-number,\n.metanno-text-view .label {\n    -webkit-touch-callout: none; /* iOS Safari */\n    -webkit-user-select: none; /* Safari */\n    -khtml-user-select: none; /* Konqueror HTML */\n    -moz-user-select: none; /* Old versions of Firefox */\n    -ms-user-select: none; /* Internet Explorer/Edge */\n    user-select: none; /* Non-prefixed version, currently supported by Chrome, Opera and Firefox */\n}\n\n.metanno-text-view .text-chunk {\n    word-break: break-word;\n    white-space: nowrap;\n    position: relative;\n    contain: layout paint;\n}\n\n.metanno-text-view .text-chunk-content {\n    position: relative;\n    z-index: 1001;\n    white-space: pre-wrap;\n}\n\n.metanno-text-view .mention_token {\n    box-sizing: content-box;\n    border-radius: 0.0000001em;\n    display: inline-block;\n\n    pointer-events: none;\n    position: absolute;\n    background-color: var(--metanno-background-color);\n    border-color: var(--metanno-border-color);\n    left: 0px;\n    right: 0px;\n    border-width: 2px;\n    border-style: solid;\n    border-right-width: 0;\n    border-left-width: 0;\n}\n\n.metanno-text-view .label {\n    box-sizing: content-box;\n    position: absolute;\n    white-space: pre;\n    border-radius: 0.2em;\n    font-size: 0.65em;\n    padding: 0.5em 0.1em 0em;\n    background: var(--metanno-background-color);\n    line-height: 0em;\n    height: 0.4em;\n    pointer-events: none;\n    color: var(--metanno-color);\n    border: 2px solid;\n    border-color: var(--metanno-color);\n}\n\n.metanno-text-view .label.highlighted {\n    outline: 2px solid #e7c600;\n    box-shadow: none;\n}\n\n.metanno-text-view .mention_token.mention_underline, .metanno-text-view .mention_token.mention_underline.closed_left, .metanno-text-view .mention_token.mention_underline.closed_right {\n    top: calc(100% - 3px);\n    border-top: 0;\n    border-top-left-radius: 0;\n    border-top-right-radius: 0;\n}\n\n.metanno-text-view .mention_token.closedleft {\n    left: -1px;\n    border-left-width: 2px;\n    border-top-left-radius: 2px;\n    border-bottom-left-radius: 2px;\n}\n\n.metanno-text-view .mention_token.closedright {\n    right: -1px;\n    border-right-width: 2px;\n    border-top-right-radius: 2px;\n    border-bottom-right-radius: 2px;\n}\n\n.metanno-text-view .mention_token.highlighted {\n    border-top-width: 4px;\n    border-bottom-width: 4px;\n}\n\n.metanno-text-view .mention_token.mention_underline, .metanno-text-view .mention_token.closedright.mention_underline, .metanno-text-view .mention_token.closedleft.mention_underline {\n    right: -2px;\n    border-top: 0;\n    border-top-left-radius: 0;\n    border-top-right-radius: 0;\n}\n\n.metanno-text-view .mention_token.closedleft.highlighted {\n    border-left-width: 4px;\n    left: -2px;\n}\n\n.metanno-text-view .mention_token.closedright.highlighted {\n    border-right-width: 4px;\n    right: -2px;\n}\n\n.metanno-text-view .mouse_selected {\n    background: rgba(137, 188, 250, 0.6); /*#b2d7ff88;*/\n    border: none;\n    min-height: var(--metanno-line-height);\n    z-index: 1000;\n}\n\n/* Style only for Mozilla Firefox */\n@-moz-document url-prefix() {\n    .metanno-text-view .mouse_selected {\n        top: 0;\n        bottom: 0;\n        min-height: unset;\n    }\n}\n\n@keyframes blink {\n    from, to {\n        border-color: white\n    }\n    50% {\n        border-color: black\n    }\n}\n\n@media (prefers-reduced-motion: no-preference) {\n    .metanno-text-view .mention_token.selected {\n        animation: var(--blink-animation);\n    }\n}\n"],"sourceRoot":""}]);
// Exports
...
var AnnotatedImage = function (props) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useImperativeHandle)(props.handle, function () { return ({}); }, []);
    var scale = 1;
    var offsetX = 0;
    var offsetY = 0;
    if (img) {
...
var Token = react__WEBPACK_IMPORTED_MODULE_1___default().memo(function (_a) {
    ...
    token_annotations.forEach(function (a) {
        ...
        if (a.mouseSelected)
            return;
        if (a.highlighted > lastAnnotation.highlighted ||
        ...
        if (annotation.mouseSelected) {
            ...
            annotations.push((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { id: "span-".concat(begin, "-").concat(end), 
                ...
                span_key: annotation.id, ref: function (element) {
                    var mouseElementKey = "".concat(annotation.id, "-span-").concat(annotation_i, "-").concat(begin, "-").concat(end);
                    if (element) {
                ...
                }, className: "mention_token mention_".concat(isUnderline && !annotation.highlighted ? "underline" : "box", "\n                               ").concat(annotation.highlighted ? "highlighted" : "", "\n                               ").concat(annotation.selected ? "selected" : "", "\n                               ").concat(isFirstTokenOfChunk && !annotation.openleft
                    ? "closedleft"
                    : "", "\n                               ").concat(isLastTokenOfChunk && !annotation.openright
                    ? "closedright"
                    : ""), style: __assign({ top: isUnderline && !annotation.highlighted
                        ? undefined
                        : verticalOffset, bottom: verticalOffset, zIndex: annotation.zIndex +
                        2 +
                        (annotation.selected ? 49 : annotation.highlighted ? 50 : 0) }, (_c = styles === null || styles === void 0 ? void 0 : styles[annotation.style]) === null || _c === void 0 ? void 0 : _c[annotation.highlighted ? "highlighted" : "base"]) }, "annotation-".concat(annotation_i)));
        }
    };
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", { className: "text-chunk", 
        ...
        span_begin: begin, children: [annotations, (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { className: "text-chunk-content", 
                // @ts-ignore
                style: {
                    color: (_e = (_d = styles === null || styles === void 0 ? void 0 : styles[lastAnnotation === null || lastAnnotation === void 0 ? void 0 : lastAnnotation.style]) === null || _d === void 0 ? void 0 : _d[(lastAnnotation === null || lastAnnotation === void 0 ? void 0 : lastAnnotation.highlighted) ? "highlighted" : "base"]) === null || _e === void 0 ? void 0 : _e.color,
                }, children: text }), isFirstTokenOfChunk &&
                token_annotations.map(function (annotation, annotation_i) {
                    var _a;
                    var _b, _c, _d;
                    if (annotation.isFirstTokenOfSpan && annotation.label) {
                        ...
                        labelIdx[shape] += 1;
                        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { className: "label ".concat(annotation.highlighted
                                ? "highlighted"
                            ...
                            span_key: annotation.id, style: (_a = {
                                ...
                                _a.left = (nLabels[shape] - labelIdx[shape]) * 6 +
                                    (shape === "box" ? -1 : 2),
                                ...
                                _a), children: annotation.labelText }, annotation.id));
                    }
                })] }));
});
var Line = react__WEBPACK_IMPORTED_MODULE_1___default().memo(function (_a) {
    var index = _a.index, styles = _a.styles, tokens = _a.tokens, spansRef = _a.spansRef, handleMouseEnterSpan = _a.handleMouseEnterSpan, handleMouseLeaveSpan = _a.handleMouseLeaveSpan, handleMouseHoverSpans = _a.handleMouseHoverSpans, handleClickSpan = _a.handleClickSpan, divRef = _a.divRef;
    ...
    var onMouseMove = function (e) {
        if (!elements || !hoveredKeys)
            return;
        var _a = getClientCoords(e), clientX = _a.clientX, clientY = _a.clientY;
        var hitElements = Object.values(elements.current)
        ...
        if (handleMouseHoverSpans) {
            handleMouseHoverSpans(e, __spreadArray([], __read(newSet), false));
        }
    };
    ...
    var onMouseUp = function (e) {
        ...
        if (hitElements.length > 1) {
            hitElements = hitElements
                ...
                .sort(function (a, b) {
                return Number.parseInt(b.style.zIndex) - Number.parseInt(a.style.zIndex);
            });
        }
...
var AnnotatedText = /** @class */ (function (_super) {
    ...
    function AnnotatedText(props) {
        ...
        _this.isNodeInside = function (node) {
        ...
        _this.handleSelectionChange = function () {
            ...
            if (_this._ignoreSelectionChange)
                return;
            var sel = typeof window !== "undefined" ? (_a = window.getSelection) === null || _a === void 0 ? void 0 : _a.call(window) : null;
            if (!sel || sel.isCollapsed)
                return;
            if (!_this.isNodeInside(sel.anchorNode) && !_this.isNodeInside(sel.focusNode))
                return;
            ...
            setTimeout(function () {
                ...
                if (spans && spans.length > 0) {
                    _this._ignoreSelectionChange = true;
                    (_b = (_a = _this.props).onMouseSelect) === null || _b === void 0 ? void 0 : _b.call(_a, spans, (0,_utils__WEBPACK_IMPORTED_MODULE_4__.makeModKeys)({}));
                    try {
        ...
        _this.handleTouchUp = function (event) {
            var _a, _b, _c, _d, _e;
            var spans = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.getDocumentSelectedRanges)();
            _this._ignoreSelectionChange = true; // prevent our own clear from retriggering
            try {
                (_a = window.getSelection()) === null || _a === void 0 ? void 0 : _a.removeAllRanges();
            }
            catch (_f) { }
            if (spans.length > 0) {
                (_c = (_b = _this.props).onMouseSelect) === null || _c === void 0 ? void 0 : _c.call(_b, spans, (0,_utils__WEBPACK_IMPORTED_MODULE_4__.makeModKeys)(event));
            }
            else {
                (_e = (_d = _this.props).onMouseSelect) === null || _e === void 0 ? void 0 : _e.call(_d, [], (0,_utils__WEBPACK_IMPORTED_MODULE_4__.makeModKeys)(event));
            }
            setTimeout(function () {
                _this._ignoreSelectionChange = false;
            }, 0);
        ...
        _this.handleClickSpan = function (event, span_id) {
            var _a, _b, _c;
            var selection = typeof window !== "undefined" ? (_a = window.getSelection) === null || _a === void 0 ? void 0 : _a.call(window) : null;
            if (selection && !selection.isCollapsed) {
                return;
            }
            (_c = (_b = _this.props).onClickSpan) === null || _c === void 0 ? void 0 : _c.call(_b, span_id, (0,_utils__WEBPACK_IMPORTED_MODULE_4__.makeModKeys)(event));
        };
        ...
        _this.handleMouseHoverSpans = function (event, span_ids) {
            var _a, _b;
            (_b = (_a = _this.props).onMouseHoverSpans) === null || _b === void 0 ? void 0 : _b.call(_a, span_ids, (0,_utils__WEBPACK_IMPORTED_MODULE_4__.makeModKeys)(event));
        };
        _this.linesRef = [];
        _this.spansRef = {};
        _this.containerRef = react__WEBPACK_IMPORTED_MODULE_1___default().createRef();
        if (props.handle) {
            var linesRef_1 = _this.linesRef;
            var spansRef_1 = _this.spansRef;
            // Problem: props.handle may be an object OR a mapping, I don't know when it is which
            props.handle.current = {
                scroll_to_line: function (line, behavior, block, inline) {
                    var _a;
                    if (behavior === void 0) { behavior = "smooth"; }
                    if (block === void 0) { block = "start"; }
                    if (inline === void 0) { inline = "nearest"; }
                    if (line >= 0 && line < linesRef_1.length && linesRef_1[line]) {
                        (_a = linesRef_1[line].current) === null || _a === void 0 ? void 0 : _a.scrollIntoView({
                            behavior: behavior,
                            block: block,
                            inline: inline,
                        });
                ...
                scroll_to_span: function (span_id, behavior, block, inline) {
                    if (behavior === void 0) { behavior = "smooth"; }
                    if (block === void 0) { block = "center"; }
                    if (inline === void 0) { inline = "nearest"; }
                    setTimeout(function () {
                        var _a, _b;
                        (_b = (_a = spansRef_1[span_id]) === null || _a === void 0 ? void 0 : _a.current) === null || _b === void 0 ? void 0 : _b.scrollIntoView({
                            behavior: behavior,
                            block: block,
                            inline: inline,
                        });
                ...
                clear_current_mouse_selection: function () {
                    window.getSelection().removeAllRanges();
                },
            };
        }
        ...
        _this.processStyles = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.memoize)(function (styles) {
            return Object.assign.apply(Object, __spreadArray([{}], __read(Object.keys(styles).map(function (key) {
                var _a;
                return (_a = {},
                    _a[key] = processStyle(styles[key]),
                    _a);
            })), false));
        });
        _this._ignoreSelectionChange = false;
        _this._boundSelectionChange = _this.handleSelectionChange.bind(_this);
        return _this;
    }
    AnnotatedText.prototype.componentDidMount = function () {
        if (!isMobileDevice())
            return;
        document.addEventListener("selectionchange", this._boundSelectionChange);
    };
    AnnotatedText.prototype.componentWillUnmount = function () {
        // Clean up handle
    ...
    AnnotatedText.prototype.render = function () {
        ...
        var _a = this.tokenize(__spreadArray(__spreadArray([], __read(this.props.mouseSelection.map(function (span) { return (__assign(__assign({}, span), { mouseSelected: true })); })), false), __read(this.props.spans), false), text, styles, this.props.beginKey, this.props.endKey, this.props.labelKey, this.props.labelFormatter, this.props.styleKey, this.props.highlightedKey, this.props.selectedKey, this.props.primaryKey), lines = _a.lines, ids = _a.ids;
        ...
        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "metanno-text-view", ref: this.containerRef, onMouseUp: this.handleMouseUp, onTouchEnd: function (e) {
                var _a;
                (_a = e.persist) === null || _a === void 0 ? void 0 : _a.call(e);
                setTimeout(function () { return _this.handleTouchUp(e); }, 0);
            }, onTouchCancel: function (e) { var _a, _b; return (_b = (_a = _this.props).onMouseSelect) === null || _b === void 0 ? void 0 : _b.call(_a, [], (0,_utils__WEBPACK_IMPORTED_MODULE_4__.makeModKeys)(e)); }, onKeyDown: this.handleKeyDown, onKeyUp: this.handleKeyUp, tabIndex: 0, style: this.props.style, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "text", children: lines.map(function (tokens, lineIndex) { return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Line, { divRef: _this.linesRef[lineIndex], spansRef: _this.spansRef, index: lineIndex, tokens: tokens, styles: styles, handleMouseEnterSpan: _this.handleMouseEnterSpan, handleMouseLeaveSpan: _this.handleMouseLeaveSpan, handleMouseHoverSpans: _this.handleMouseHoverSpans, handleClickSpan: _this.handleClickSpan }, lineIndex)); }) }) }));
    };
...
function styleTextChunks_(text_chunks, spans, styles, outset) {
    ...
    spans.forEach(function (_a, span_i) {
        var e_1, _b;
        var _c, _d, _e, _f;
        var begin = _a.begin, end = _a.end, label = _a.label, labelText = _a.labelText, style = _a.style, rest = __rest(_a, ["begin", "end", "label", "labelText", "style"]);
        style = style || label;
        ...
        for (var text_chunk_i = 0; text_chunk_i < text_chunks.length; text_chunk_i++) {
            if (text_chunks[text_chunk_i].begin < end &&
                ...
                var annotation = __assign({ depth: newDepth, openleft: text_chunks[text_chunk_i].begin !== begin, openright: text_chunks[text_chunk_i].end !== end, label: label, labelText: labelText, isFirstTokenOfSpan: text_chunks[text_chunk_i].begin === begin, style: style, zIndex: newZIndex }, rest);
...
function tokenize(spans, text, styles, beginKey, endKey, labelKey, labelFormatter, styleKey, highlightedKey, selectedKey, idKey) {
    spans = spans.map(function (span, span_i) {
        var _a;
        var rawLabel;
        try {
            ...
            rawLabel = (_a = span[labelKey]) === null || _a === void 0 ? void 0 : _a.toUpperCase();
        }
        var resolvedLabel = rawLabel === undefined || rawLabel === null || rawLabel === ""
            ? null
            : String(rawLabel);
        return {
            begin: span[beginKey],
...
var TableFiltersContext = react__WEBPACK_IMPORTED_MODULE_1___default().createContext(null);
TableFiltersContext.displayName = "TableFiltersContext";
var TableFilterInput = (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(function TableFilterInput(_a) {
    var _b;
    var columnKey = _a.columnKey, inputProps = _a.inputProps;
    var filtersContext = react__WEBPACK_IMPORTED_MODULE_1___default().useContext(TableFiltersContext);
    var filterValue = (_b = filtersContext === null || filtersContext === void 0 ? void 0 : filtersContext.filters) === null || _b === void 0 ? void 0 : _b[columnKey];
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("input", __assign({}, inputProps, { className: "metanno-table-filter", value: filterValue || "", onChange: function (e) { return filtersContext === null || filtersContext === void 0 ? void 0 : filtersContext.onFilterChange(columnKey, e.target.value); }, onKeyDown: inputStopPropagation })));
});
var Table = function Table(_a) {
    var _b;
    var primaryKey = _a.primaryKey, rows = _a.rows, selection = _a.selection, multiSelectionMode = _a.multiSelectionMode, filters = _a.filters, columns = _a.columns, autoFilter = _a.autoFilter, subset = _a.subset, onSubsetChange = _a.onSubsetChange, handle = _a.handle, onInputChange = _a.onInputChange, inputValue = _a.inputValue, onMouseEnterRow = _a.onMouseEnterRow, onMouseLeaveRow = _a.onMouseLeaveRow, onMouseHoverRow = _a.onMouseHoverRow, highlightedRows = _a.highlightedRows, style = _a.style, onFiltersChange = _a.onFiltersChange, onSelectionChange = _a.onSelectionChange, onCellChange = _a.onCellChange, onScrollBottom = _a.onScrollBottom, onClickCellContent = _a.onClickCellContent, suggestions = _a.suggestions;
    var _c = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(columns.map(function (column) { return column.key; })), 2), columnsOrder = _c[0], setColumnsOrder = _c[1];
    var _d = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(undefined), 2), localSelection = _d[0], setLocalSelection = _d[1];
    var _e = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false), 2), isLoading = _e[0], setIsLoading = _e[1];
    // If filters are not controlled via props, we use local state
    var _f = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({}), 2), localFilters = _f[0], setLocalFilters = _f[1];
    var currentHoveredRow = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
    var effectiveFilters = filters === undefined ? localFilters : filters;
    var controlledSelection = selection;
    ...
    var rowsRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(rows);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    ...
    var localSubset = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () {
        if (autoFilter &&
            ...
            onSubsetChange === null || onSubsetChange === void 0 ? void 0 : onSubsetChange(newSubset);
            return newSubset;
        }
        else {
            return undefined;
    ...
    var effectiveSubset = subset !== undefined ? subset : localSubset;
    var handleFilterChange = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useEventCallback)(function (columnKey, value) {
        var _a;
        var newFilters = __assign(__assign({}, effectiveFilters), (_a = {}, _a[columnKey] = value, _a));
        onFiltersChange === null || onFiltersChange === void 0 ? void 0 : onFiltersChange(newFilters, columnKey);
        if (filters === undefined) {
            setLocalFilters(function (prev) {
                var _a;
                return (__assign(__assign({}, prev), (_a = {}, _a[columnKey] = value, _a)));
            });
        }
    });
    var filtersContextValue = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () { return ({
        filters: effectiveFilters,
        onFilterChange: handleFilterChange,
    }); }, [effectiveFilters, handleFilterChange]);
    // Update actions to work with absolute indices.
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useImperativeHandle)(handle, function () { return ({
        scroll_to_row_idx: function (absRowIdx) {
            var _a;
            var relativeIdx = effectiveSubset
        ...
        scroll_to_row_id: function (key) {
            var _a;
            if (!primaryKey)
                return;
            var absRowIdx = rowsRef.current.findIndex(function (row) { return row[primaryKey] === key; });
            var relativeIdx = effectiveSubset
                ? effectiveSubset.indexOf(absRowIdx)
                : absRowIdx;
            if (relativeIdx !== -1) {
    ...
    var visibleRows = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () {
        if (effectiveSubset !== undefined) {
            return effectiveSubset.map(function (idx) { return rows[idx]; });
        }
        return rows;
    }, [rows, effectiveSubset]);
    var makeInputChangeHandler = function (relativeRowIdx, column) {
        return function (value, cause) {
            var absRowIdx = getAbsoluteRowIdx(relativeRowIdx);
            onInputChange === null || onInputChange === void 0 ? void 0 : onInputChange(primaryKey && absRowIdx !== null ? rowsRef.current[absRowIdx][primaryKey] : null, absRowIdx, column.key, value, cause);
        };
    };
    ...
    var makeFilterInput = function (column) {
        return column.filterable
            ? function (inputProps) { return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(TableFilterInput, { inputProps: inputProps, columnKey: column.key })); }
            : null;
    };
        ...
        switch (type) {
                ...
                return {
                    editor: readonly
                        ...
                        : (0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(function (_a, ref) {
                            ...
                            return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_InputSuggest__WEBPACK_IMPORTED_MODULE_8__.SingleInputSuggest, { ref: ref, 
                                ...
                                row_id: getAbsoluteRowIdx(rowIdx), inputRef: inputRef, value: row[column.key], column: column.key, inputValue: inputValue, onInputChange: makeInputChangeHandler(rowIdx, column), suggestions: suggestions === undefined
                                    ? columns[column.idx].choices
                                    : suggestions, onRowChange: onRowChange, onClose: onClose, hyperlink: true }));
                        }),
                    ...
                    formatter: function (_a) {
                        ...
                        return value ? ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("a", { onClick: function (event) {
                                var res = onClickCellContent === null || onClickCellContent === void 0 ? void 0 : onClickCellContent(primaryKey ? row[primaryKey] : null, rowIdx, column.key, href);
                                if (res) {
                                    event.preventDefault();
                                    event.stopPropagation();
                                }
                ...
                return {
                    editor: readonly
                        ...
                        : (0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(function (_a, ref) {
                            ...
                            var suggestions = react__WEBPACK_IMPORTED_MODULE_1___default().useContext(SuggestionsContext);
                            return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_InputSuggest__WEBPACK_IMPORTED_MODULE_8__.MultiInputSuggest, { ref: ref, row_id: getAbsoluteRowIdx(rowIdx), inputRef: inputRef, value: row[column.key], inputValue: inputValue, column: column.key, suggestions: suggestions === undefined
                                    ? columns[column.idx].choices
                                    : suggestions, onRowChange: onRowChange, onInputChange: makeInputChangeHandler(rowIdx, column), onClose: onClose, hyperlink: true }));
                        }),
                    headerCellClass: filterable
                        ? "metanno-table-header-filter"
                        : undefined,
                    ...
                    formatter: function (_a) {
                        var row = _a.row, rowIdx = _a.rowIdx, column = _a.column;
                        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_InputSuggest__WEBPACK_IMPORTED_MODULE_8__.InputTag, { autocontain: true, readOnly: true, hyperlink: true, onClick: function (value) {
                                return onClickCellContent === null || onClickCellContent === void 0 ? void 0 : onClickCellContent(primaryKey ? row[primaryKey] : null, rowIdx, column.key, value);
            ...
            case "button":
                return {
                    formatter: function (_a) {
                        var row = _a.row, rowIdx = _a.rowIdx, column = _a.column;
                        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", { onClick: function () {
                                return onClickCellContent === null || onClickCellContent === void 0 ? void 0 : onClickCellContent(primaryKey && rowIdx !== null ? rowsRef.current[rowIdx][primaryKey] : null, rowIdx, column.key);
                            }, children: column.key }));
                    },
                };
            default:
    ...
    var builtColumns = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () {
        var columnObjects = columns.map(function (column) {
            var _a;
    ...
    var onRowsChange = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useEventCallback)(function (newRows) {
        ...
        if (updatedRows.length === 1) {
            var _a = updatedRows[0], newRow_1 = _a.newRow, oldRow_1 = _a.oldRow, absRowIdx = _a.absRowIdx;
            var changedKeys = Object.keys(newRow_1).filter(function (key) { return newRow_1[key] !== oldRow_1[key]; });
            onCellChange === null || onCellChange === void 0 ? void 0 : onCellChange(primaryKey ? oldRow_1[primaryKey] : null, absRowIdx, changedKeys[0], newRow_1[changedKeys[0]]);
        }
    });
    ...
    var MetannoRow = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () {
        return (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)((0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(function (p, ref) { return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_data_grid__WEBPACK_IMPORTED_MODULE_4__.Row, __assign({}, p, { ref: ref, onMouseEnter: function (event) {
                var rowIdx = getAbsoluteRowIdx(p.rowIdx);
                if (currentHoveredRow.current === rowIdx) {
                    return;
                }
                onMouseEnterRow === null || onMouseEnterRow === void 0 ? void 0 : onMouseEnterRow(primaryKey ? rowsRef.current[rowIdx][primaryKey] : null, rowIdx, (0,_utils__WEBPACK_IMPORTED_MODULE_6__.makeModKeys)(event));
                onMouseHoverRow === null || onMouseHoverRow === void 0 ? void 0 : onMouseHoverRow(primaryKey ? rowsRef.current[rowIdx][primaryKey] : null, rowIdx, (0,_utils__WEBPACK_IMPORTED_MODULE_6__.makeModKeys)(event));
                if (currentHoveredRow.current !== null) {
                    onMouseLeaveRow === null || onMouseLeaveRow === void 0 ? void 0 : onMouseLeaveRow(rowsRef.current[currentHoveredRow.current][primaryKey], currentHoveredRow.current, (0,_utils__WEBPACK_IMPORTED_MODULE_6__.makeModKeys)(event));
                }
                ...
                setTimeout(function () {
                    if (currentHoveredRow.current === rowIdx) {
                        onMouseLeaveRow === null || onMouseLeaveRow === void 0 ? void 0 : onMouseLeaveRow(primaryKey ? rowsRef.current[currentHoveredRow.current][primaryKey] : null, currentHoveredRow.current, (0,_utils__WEBPACK_IMPORTED_MODULE_6__.makeModKeys)(event));
                        onMouseHoverRow === null || onMouseHoverRow === void 0 ? void 0 : onMouseHoverRow(null, null, (0,_utils__WEBPACK_IMPORTED_MODULE_6__.makeModKeys)(event));
                        currentHoveredRow.current = null;
                    }
                }, 50);
            }, className: "metanno-row ".concat(p.className) }))); }));
    }, [onMouseEnterRow, onMouseLeaveRow]);
    var renderRow = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(function (p) { return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(MetannoRow, __assign({}, p, { className: primaryKey && (highlightedRows === null || highlightedRows === void 0 ? void 0 : highlightedRows.includes(p.row[primaryKey]))
            ? "metanno-row--highlighted"
            : "" }))); }, [highlightedRows, primaryKey]);
    var rowKeyGetter = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(function (row) { return row[primaryKey]; }, [primaryKey]);
    var handleSelectionChange = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useEventCallback)(function (_a) {
        var _b, _c;
        var idx = _a.idx, rowIdx = _a.rowIdx, mode = _a.mode, ranges = _a.ranges, _d = _a.cause, cause = _d === void 0 ? "key" : _d;
        var absoluteRowIdx = rowIdx !== null && rowIdx >= 0 ? getAbsoluteRowIdx(rowIdx) : null;
        var hasAbsoluteRowIdx = absoluteRowIdx !== null &&
            absoluteRowIdx !== undefined &&
            absoluteRowIdx >= 0;
        var col = idx !== null && idx >= 0 ? columnsOrder[idx] : null;
        var relativeRangeRows = Array.isArray(ranges) && ranges.length > 0
            ? ranges.map(function (range) { return range.rowIdx; })
            : hasAbsoluteRowIdx
                ? [rowIdx]
                : [];
        var absoluteSelectedRows = Array.from(new Set(relativeRangeRows
            .filter(function (relativeRowIdx) { return relativeRowIdx >= 0; })
            .map(function (relativeRowIdx) { return getAbsoluteRowIdx(relativeRowIdx); })
            .filter(function (absoluteIdx) { return absoluteIdx !== null && absoluteIdx !== undefined && absoluteIdx >= 0; })));
        var rowId = primaryKey && hasAbsoluteRowIdx
            ? (_c = (_b = rowsRef.current[absoluteRowIdx]) === null || _b === void 0 ? void 0 : _b[primaryKey]) !== null && _c !== void 0 ? _c : null
            : null;
        var absoluteRanges = absoluteSelectedRows.map(function (selectedRowIdx) { return ({
            row_idx: selectedRowIdx,
        }); });
        onSelectionChange === null || onSelectionChange === void 0 ? void 0 : onSelectionChange(rowId, hasAbsoluteRowIdx ? absoluteRowIdx : null, col, mode, cause, absoluteRanges);
    ...
    var getSelectionIndices = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useCachedReconcile)(function (selectionParam) {
        if (!selectionParam)
            return undefined;
        var row_idx = selectionParam.row_idx, col = selectionParam.col, mode = selectionParam.mode, ranges = selectionParam.ranges;
        var hasRowSelection = row_idx !== null && row_idx !== undefined && row_idx >= 0;
        var relativeRowIdx = hasRowSelection
            ? effectiveSubset
                ? effectiveSubset.indexOf(row_idx)
                : row_idx
            : -2;
        var absoluteSelectedRows = Array.isArray(ranges) && ranges.length > 0
            ? ranges.map(function (range) { return range.row_idx; })
            : hasRowSelection && relativeRowIdx >= 0
                ? [row_idx]
                : [];
        var relativeSelectedRows = Array.from(new Set(absoluteSelectedRows
            .map(function (absoluteRowIdx) {
            return effectiveSubset ? effectiveSubset.indexOf(absoluteRowIdx) : absoluteRowIdx;
        })
            .filter(function (relativeIdx) { return relativeIdx >= 0; })));
        var idx = col ? columnsOrder.findIndex(function (name) { return col === name; }) : -1;
        return {
            rowIdx: relativeRowIdx,
            idx: idx,
            mode: mode,
            ranges: relativeSelectedRows.map(function (relativeRow) { return ({ rowIdx: relativeRow }); }),
        };
    });
    var onBlur = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useEventCallback)(function (event) {
        if (event.currentTarget.contains(event.relatedTarget))
            return;
        var effectiveSelection = controlledSelection !== undefined ? controlledSelection : localSelection;
        if ((effectiveSelection === null || effectiveSelection === void 0 ? void 0 : effectiveSelection.mode) === "EDIT")
            return;
        if (effectiveSelection == null)
            return;
        var ranges = Array.isArray(effectiveSelection.ranges) && effectiveSelection.ranges.length > 0
            ? effectiveSelection.ranges
                .map(function (range) {
                var absoluteRowIdx = range === null || range === void 0 ? void 0 : range.row_idx;
                if (absoluteRowIdx === null ||
                    absoluteRowIdx === undefined ||
                    absoluteRowIdx < 0) {
                    return null;
                }
                var relativeRowIdx = effectiveSubset
    ...
    var handleScrollBottom = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useEventCallback)(function (event) {
        ...
        var approachesBottom = currentTarget.scrollTop + 10 >=
        ...
        setIsLoading(true);
        var result = onScrollBottom(event);
    ...
    var headerRowHeight = columns.some(function (col) { return col.filterable; })
        ? HEADER_ROW_HEIGHT
        : ROW_HEIGHT;
    var selectedSelection = (_b = getSelectionIndices(controlledSelection !== undefined ? controlledSelection : localSelection)) !== null && _b !== void 0 ? _b : {
        rowIdx: -2,
        idx: -1,
        mode: "SELECT",
    };
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(SuggestionsContext.Provider, { value: suggestions, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(TableFiltersContext.Provider, { value: filtersContextValue, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "metanno-table", style: style, onBlur: onBlur, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_dnd__WEBPACK_IMPORTED_MODULE_2__.DndProvider, { backend: react_dnd_html5_backend__WEBPACK_IMPORTED_MODULE_3__.HTML5Backend, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_data_grid__WEBPACK_IMPORTED_MODULE_4__["default"], { ref: gridRef, rowKeyGetter: rowKeyGetter, rowHeight: ROW_HEIGHT, selection: selectedSelection, multiSelectionMode: multiSelectionMode, columns: builtColumns, rows: visibleRows, rowRenderer: renderRow, headerRowHeight: headerRowHeight, onRowsChange: onRowsChange, onSelectionChange: handleSelectionChange, onScroll: handleScrollBottom }) }) }) }) }));
};
...
//# sourceMappingURL=client_style_css-client_dist-globals_ts.e99d1ba1fa4f76db525c.js.map