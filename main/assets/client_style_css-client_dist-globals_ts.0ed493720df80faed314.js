            ...
            props.handle.current = {
                scroll_to_line: function (line, behavior) {
                    ...
                    if (line >= 0 && line < _this.linesRef.length && _this.linesRef[line]) {
                        (_a = _this.linesRef[line].current) === null || _a === void 0 ? void 0 : _a.scrollIntoView({
                            behavior: behavior,
                            block: "center",
                        });
                    }
                ...
                scroll_to_span: function (span_id, behavior) {
                    ...
                    setTimeout(function () {
                        ...
                        if (_this.spansRef[span_id]) {
                            (_a = _this.spansRef[span_id].current) === null || _a === void 0 ? void 0 : _a.scrollIntoView({
                                behavior: behavior,
                                block: "center",
                            });
                        }
...
//# sourceMappingURL=client_style_css-client_dist-globals_ts.0ed493720df80faed314.js.map