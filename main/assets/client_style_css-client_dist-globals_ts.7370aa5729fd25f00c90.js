    ...
    function AnnotatedText(props) {
        ...
        if (props.handle) {
            ...
            props.handle.current = {
                scroll_to_line: function (line, behavior) {
                    var _a;
                ...
                scroll_to_span: function (span_id, behavior) {
                    if (behavior === void 0) { behavior = "smooth"; }
                    setTimeout(function () {
                        var _a, _b;
...
//# sourceMappingURL=client_style_css-client_dist-globals_ts.7370aa5729fd25f00c90.js.map